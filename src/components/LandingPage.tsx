                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight leading-tight">
                      Raised to Lead: Outstanding Achievements at Edweso Royal
                      Academy
                    </h3>
                    <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-2xl">
                      Edweso Royal Academy couples international standard
                      facilities and curriculum models with stellar local
                      performance standards. From our 100% BECE completion rates
                      to our direct cashless Paystack platform, we lead.
                    </p>
                  </div>
