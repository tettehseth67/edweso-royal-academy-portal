...
export default function LandingPage({ onNavigateToLogin }: LandingPageProps) {
  ...
  const [selectedResourceTab, setSelectedResourceTab] = useState<
  ...
  const [academicDept, setAcademicDept] = useState<"primary" | "jhs" | "shs">(
    "jhs",
  );
  ...
  const testimonials = [
    {
      quote:
        "Edweso Royal Academy has brought out the best in our children. The discipline and teachers' dedication are exceptional. Paying school fees via Mobile Money makes our lives so much easier!",
    ...
    {
      quote:
        "As a student here, I love the supportive teachers and our science and computer lab experiments. The student portal lets me track my terminal grades easily.",
    ...
    {
      quote:
        "The academic standards at Edweso Royal Academy are comparable to top-tier schools in Accra. Their modern approach to ICT and programming is preparing students for the future.",
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 flex flex-col justify-between">
      ...
      <nav
        id="landing-navbar"
        className="bg-white/90 backdrop-blur-md sticky top-0 z-40 border-b border-slate-100 px-4 py-3 sm:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <div>
              <span className="font-extrabold text-lg tracking-tight text-emerald-800 block leading-tight">
                Edweso Royal
              </span>
              <span className="text-[10px] uppercase font-bold tracking-widest text-amber-600 block leading-none">
                Academy
              </span>
            </div>
          </div>
      ...
      <div className="flex-1">
        ...
        {activePage === "home" && (
          <div className="animate-fade-in">
            ...
            <section
              id="landing-hero"
              className="relative bg-gradient-to-br from-emerald-900 via-emerald-950 to-slate-950 text-white py-16 lg:py-24 px-4 overflow-hidden border-b-4 border-amber-400"
            >
              ...
              <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 text-left">
                  ...
                  <p className="text-emerald-100/90 text-sm sm:text-base leading-relaxed max-w-2xl font-medium">
                    Edweso Royal Academy offers an ultra-modern educational
                    environment in Edweso, Ghana, combining the national GES
                    curriculum with advanced computing, moral discipline, and
                    direct Paystack integrations.
                  </p>
                ...
                <div className="lg:col-span-5">
                  <div className="bg-slate-900/95 border border-slate-800/85 rounded-2xl shadow-2xl p-6 space-y-4 backdrop-blur-xs">
                    <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                      ...
                      <span className="text-[9px] font-mono font-bold text-amber-400 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-400/20">
                    ...
                    <div className="space-y-3.5">
                      ...
                      <div className="p-3 bg-emerald-950/40 border border-emerald-900/40 rounded-xl space-y-1">
                        ...
                        <h4 className="font-extrabold text-xs text-white">
                          Continuous Assessment (SBA) Review
                        </h4>
                        <p className="text-[11px] text-emerald-200/80 leading-relaxed">
                          Teachers are uploading Term III assessment records.
                          Parents can check active class grade metrics.
                        </p>
                      </div>
                      ...
                      <div className="p-3 bg-slate-950/60 border border-slate-800/60 rounded-xl space-y-1">
                        ...
                        <h4 className="font-extrabold text-xs text-white">
                          Paystack MoMo Portal Online
                        </h4>
                        <p className="text-[11px] text-slate-300/80 leading-relaxed">
                          Pay tuition fees instantly with MTN, Telecel, or
                          AirtelTigo. Instant digitized receipting active.
                        </p>
                      </div>
                      ...
                      <div className="p-3 bg-slate-950/60 border border-slate-800/60 rounded-xl space-y-1">
                        ...
                        <p className="text-[11px] text-slate-300/80 leading-relaxed">
                          Join us at the Main Assembly Hall to review academic
                          targets and infrastructure updates.
                        </p>
                      </div>
                    </div>
            ...
            <section className="bg-white py-6 border-b border-slate-100">
              <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-2xl sm:text-3xl font-extrabold text-emerald-800 animate-pulse">
                    450+
                  </div>
            ...
            <section
              id="features"
              className="py-16 sm:py-20 px-4 max-w-7xl mx-auto space-y-12"
            >
              <div className="text-center max-w-3xl mx-auto space-y-3">
                ...
                <p className="text-slate-500 text-xs sm:text-sm">
                  Everything our administrative, teaching, and student bodies
                  need, unified under one highly performant digital SaaS portal.
                </p>
              </div>
            ...
            <section className="bg-emerald-950 text-white py-16 px-4">
              <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <h2 className="text-2xl sm:text-4xl font-extrabold tracking-tight font-sans leading-tight">
                    Ghana Curriculum Built For 21st Century Brilliance
                  </h2>
                  <p className="text-emerald-200 text-xs sm:text-sm leading-relaxed">
                    At Edweso Royal Academy, we strictly implement the National
                    Council for Curriculum and Assessment (NaCCA) guidelines. We
                    combine core academic competencies with practical computing,
                    moral character learning (RME), and physical culture
                    development.
                  </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-xs text-emerald-100 font-medium">
                        Highly certified teachers from top-tier pedagogical
                        universities (UEW & UCC).
                      </p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle2
                      ...
                      />
                      <p className="text-xs text-emerald-100 font-medium">
                        Fully equipped ICT Laboratory with personal computers
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      />
                      <p className="text-xs text-emerald-100 font-medium">
                        Continuous evaluations coupled with direct online fees
                  ...
                  <div className="bg-emerald-900 border border-emerald-800 p-6 rounded-2xl shadow-xl space-y-4">
                    <div className="flex items-center justify-between border-b border-emerald-800 pb-3">
                      ...
                      <span className="font-mono text-xs text-emerald-400">
                        edweso-academy-live-terminal
                      </span>
                    </div>

                    <div className="space-y-3 font-mono text-xs text-emerald-200">
                      <p className="text-emerald-400">
                        // Collation of JHS 2 Terminal Results
                      </p>
                      ...
                      <p className="text-amber-400">
                        // Transaction logged via Paystack MTN MoMo
                      </p>
                      <div className="p-3 bg-emerald-950/80 rounded border border-emerald-800/50 space-y-1 text-[11px]">
                        <p>
                          Ref:{" "}
                          <strong className="text-white">PSTK-734891240</strong>
                        </p>
            ...
            <section
              id="testimonials"
              className="py-16 sm:py-20 px-4 bg-slate-100"
            >
              <div className="max-w-7xl mx-auto space-y-12">
                <div className="text-center max-w-2xl mx-auto space-y-2">
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    What Our Royal Parents Say
                  </h2>
                  <p className="text-slate-500 text-xs sm:text-sm">
                    We partner closely with parents to ensure continuous
                    developmental tracking, moral values, and academic
                    excellence.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {testimonials.map((test, idx) => (
                    <div
                      key={idx}
                      className="bg-white p-6 rounded-xl shadow-xs border border-slate-200/50 flex flex-col justify-between"
                    >
        ...
        {activePage === "about" && (
          <div className="animate-fade-in space-y-12 py-12 px-4 max-w-7xl mx-auto">
            ...
            <div className="text-center space-y-3 max-w-3xl mx-auto">
              <span className="text-xs font-extrabold uppercase bg-emerald-50 text-emerald-700 px-3 py-1 rounded-full border border-emerald-500/15">
                Who We Are
              </span>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight">
                Our History, Vision & Values
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                Edweso Royal Academy stands as a beacon of standard K-12
                learning in the Edweso Municipality, raising character-driven,
                highly proficient leaders since 2012.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="space-y-2">
                  <span className="font-mono text-emerald-700 text-xs font-bold uppercase tracking-widest block">
                    // A Humble Genesis
                  </span>
                  <h2 className="text-2xl font-bold text-slate-900 leading-snug">
                    From 15 Pupils to Ashanti's Educational Pillar
                  </h2>
                </div>

                <p className="text-xs text-slate-600 leading-relaxed">
                  Established in September 2012 with a pioneer cohort of only 15
                  primary children, our goal was simple yet profound: to build
                  an educational hub that does not force rote learning, but
                  rather inspires holistic comprehension, high discipline, and
                  technological mastery.
                </p>

                <p className="text-xs text-slate-600 leading-relaxed">
                  Today, Edweso Royal Academy houses over 450 active students
                  spanning primary levels up to Senior High School. Equipped
                  with modern computing, scientific labs, and a fully accredited
                  National Council for Curriculum and Assessment (NaCCA)
                  syllabus, our graduates consistently excel in BECE and
              ...
              <div className="space-y-6">
                <div className="p-6 bg-emerald-900 text-white rounded-2xl shadow-md border-r-4 border-amber-400">
                  ...
                  <p className="text-xs text-emerald-100 leading-relaxed">
                    To deliver premium, values-based, technology-integrated
                    education that empowers students with core problem-solving
                    capability, strong moral integrity, and the confidence to
                    lead within Ghana and the global landscape.
                  </p>
                </div>
                ...
                <div className="p-6 bg-slate-900 text-white rounded-2xl shadow-md border-r-4 border-emerald-600">
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed">
                    To be acknowledged as the most prestigious model institution
                    in the Ashanti Region for comprehensive academic rigor, STEM
                    competence, character grooming, and practical digital
                    literacy by 2030.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-100 p-8 rounded-2xl shadow-xs space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-extrabold text-slate-900">
                  Values We Cultivate Daily
                </h3>
                <p className="text-xs text-slate-400">
                  The cultural DNA governing students, parents, and faculty
                  alike.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-center space-y-2">
                  <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 font-bold mx-auto">
                    K
                  </div>
                  ...
                  <p className="text-[10px] text-slate-500 leading-relaxed">
                    Striving for deep cognitive understanding, critical
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-center space-y-2">
                  ...
                  <p className="text-[10px] text-slate-500 leading-relaxed">
                    Instilling self-control, prompt attendance, respect for
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-center space-y-2">
                  ...
                  <p className="text-[10px] text-slate-500 leading-relaxed">
                    Refusing average scores. Working hard to record straight
                    'A's in the continuous terminal ledgers.
                  </p>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-center space-y-2">
                  <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 font-bold mx-auto">
                  ...
                  <p className="text-[10px] text-slate-500 leading-relaxed">
                    Embracing computers, typing, core programming, and modern
                    sciences to remain future-ready.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h3 className="text-xl font-extrabold text-slate-900 mt-1">
                  Our Senior School Administrators
                </h3>
                <p className="text-xs text-slate-400">
                  Guiding the academic and physical progress of the student
                  body.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-100 flex items-center space-x-4">
                  ...
                  <div>
                    <h5 className="font-extrabold text-xs text-slate-900">
                      Madam Margaret Mensah
                    </h5>
                    <p className="text-[10px] text-slate-400 uppercase font-bold mt-0.5">
                      VP Academic Affairs
                    </p>
                    <p className="text-[9px] text-emerald-700 mt-1">
                      B.Sc Science (UCC Cape Coast)
                    </p>
                  </div>
                </div>
          ...
          <div className="animate-fade-in space-y-12 py-12 px-4 max-w-7xl mx-auto">
            ...
            <div className="text-center space-y-3 max-w-3xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
                Our Academic Department Divisions
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                Adhering tightly to the Ghana Education Service (GES) and NaCCA
                directives to foster holistic development.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1 space-y-4">
                {academicDept === "primary" && (
                  <div className="space-y-4">
                    <span className="text-xs font-bold text-emerald-700 uppercase block tracking-wider">
                      Foundation Division
                    </span>
                    <h3 className="text-xl font-bold text-slate-900">
                      Preschool & Lower/Upper Primary
                    </h3>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      At the primary level, we establish robust foundational
                      literacy and computational mathematics. Children explore
                      fundamental physical science, Twi, English grammar, and
                      Creative Arts.
                    </p>
                ...
                {academicDept === "jhs" && (
                  <div className="space-y-4">
                    <span className="text-xs font-bold text-emerald-700 uppercase block tracking-wider">
                      Continuous Assessment Division
                    </span>
                    <h3 className="text-xl font-bold text-slate-900">
                      Junior High School (JHS 1 - JHS 3)
                    </h3>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Rigorous grooming prepared for the Basic Education
                      Certificate Examination (BECE). We implement the strict
                      continuous assessment system (30% internal class work, 70%
                    ...
                    <div className="bg-slate-100 p-4 rounded-xl space-y-1.5 border border-slate-200/40 text-[11px] text-slate-600 font-semibold">
                      ...
                      <p>
                        • Practical ICT (Computer typing & programming theory)
                      </p>
                ...
                {academicDept === "shs" && (
                  <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-bold text-slate-900">
                      Senior High School (SHS 1)
                    </h3>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Pre-tertiary academic division focus on high-tier science,
                      business, and general arts pathways to ensure a 100% pass
                      rate in the WASSCE.
                    </p>
                    <div className="bg-slate-100 p-4 rounded-xl space-y-1.5 border border-slate-200/40 text-[11px] text-slate-600 font-semibold">
                      <p className="text-slate-800 font-bold">
              ...
              <div className="lg:col-span-2 bg-white border border-slate-100 rounded-xl p-5 shadow-xs space-y-4">
                ...
                <div className="flex items-center space-x-2 text-[10px] text-emerald-800 font-semibold bg-emerald-50 p-2.5 rounded">
                  ...
                  <span>
                    Interactive timetables prevent scheduling overlaps for
                    teachers and classes automatically inside the school
                    database.
                  </span>
                </div>
              </div>
        ...
        {activePage === "admissions" && (
          <div className="animate-fade-in py-12 px-4 max-w-7xl mx-auto space-y-12">
            ...
            <div className="text-center space-y-3 max-w-3xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
                School Admissions & Tuition Fee Structure
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                Clear, transparent, and direct pricing with zero hidden charges.
                Submit an online enrollment inquiry below to reserve a seat.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-5 rounded-2xl border border-slate-100 flex flex-col justify-between text-center relative overflow-hidden group hover:border-emerald-500/25 transition-colors">
                <div className="space-y-3">
                  ...
                  <span className="text-[9px] text-slate-400 block font-bold uppercase tracking-widest mt-1">
                    Per Term Tuition
                  </span>
                </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-emerald-500/20 bg-emerald-50/10 flex flex-col justify-between text-center relative overflow-hidden group hover:border-emerald-500/25 transition-colors">
                <div className="absolute top-0 right-0 bg-emerald-600 text-white text-[8px] font-bold uppercase px-2 py-0.5 rounded-bl">
                  Popular
                </div>
                <div className="space-y-3">
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mt-1">
                    3 Simple Steps to Enroll Your Child
                  </h3>
                </div>

                <div className="space-y-5">
                  <div className="flex items-start space-x-4">
                    <span className="w-8 h-8 rounded-full bg-emerald-50 text-emerald-700 flex items-center justify-center font-extrabold text-xs shrink-0 mt-0.5">
                      1
                    </span>
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 leading-relaxed mt-1">
                        Fill out the parent details and student grade level on
                        this portal. It directly records the inquiry under the
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 leading-relaxed mt-1">
                        Admissions staff will phone you to schedule a primary
                        reading or mathematics aptitude assessment to evaluate
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h5 className="font-bold text-xs text-slate-900">
                        Filing & Fees Clearance
                      </h5>
                      <p className="text-[10px] text-slate-500 leading-relaxed mt-1">
                        Clear termly tuition and computer fees directly via the
                        Paystack student portal (Mobile Money MTN/Telecel) to
                        trigger automated admission card generation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {isAdmissionSubmitted ? (
                  <div className="p-6 bg-emerald-50 border border-emerald-100 rounded-xl space-y-4 text-center animate-fade-in">
                    ...
                    <div className="space-y-1">
                      <h4 className="font-extrabold text-emerald-800 text-sm uppercase">
                    ...
                    <p className="text-[11px] text-slate-600 leading-relaxed max-w-md mx-auto">
                      Thank you for applying to Edweso Royal Academy! We have
                      recorded your admissions interest inside our admin
                      database dashboard. Our Registrar will call your phone
                      coordinate shortly.
                    </p>
                    <button
        ...
        {activePage === "contact" && (
          <div className="animate-fade-in py-12 px-4 max-w-7xl mx-auto space-y-12">
            ...
            <div className="text-center space-y-3 max-w-3xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
                Reach the Edweso Administration
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
                Have a general query, PTA feedback, or partnership suggestion?
                Contact us directly.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-5 rounded-xl border border-slate-100 flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-extrabold text-xs text-slate-950 uppercase tracking-wide">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-5 bg-white border border-slate-100 rounded-2xl p-5 shadow-xs space-y-4">
                <div className="flex justify-between items-center border-b pb-3 border-slate-100">
                  ...
                  <span className="text-[9px] bg-emerald-500/10 text-emerald-600 px-2 py-0.5 rounded font-bold uppercase">
                    Pulsing Active Location
                  </span>
                </div>
                ...
                <div className="h-64 bg-slate-100 rounded-lg relative overflow-hidden border border-slate-200/50 flex flex-col justify-between p-3 select-none">
                  ...
                  <div className="relative flex justify-between">
                    <span className="text-[8px] font-bold text-slate-400 uppercase bg-white/70 px-1 py-0.5 rounded">
                      To Kumasi (Main Rd)
                    </span>
                    <span className="text-[8px] font-bold text-slate-400 uppercase bg-white/70 px-1 py-0.5 rounded">
                      Edweso Junction
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                    ...
                    <div className="w-4 h-4 bg-emerald-700 text-amber-400 border border-amber-300 rounded-full flex items-center justify-center font-bold text-[9px] shadow-md z-10">
                      E
                    </div>
                    <span className="bg-slate-900 text-white text-[8px] font-bold px-1.5 py-0.5 rounded mt-1 shadow-sm whitespace-nowrap z-10">
                ...
                <p className="text-[10px] text-slate-500 leading-relaxed font-semibold">
                  * Located directly behind the Edweso Municipal Assembly
                  office. Parents can take standard transport to Edweso
                  Junction, and take the school link spur for 2 minutes.
                </p>
              </div>
              ...
              <div className="lg:col-span-7 bg-white border border-slate-200/40 rounded-2xl p-6 sm:p-8">
                {isContactSubmitted ? (
                  <div className="p-6 bg-emerald-50 border border-emerald-100 rounded-xl space-y-4 text-center animate-fade-in font-sans">
                    ...
                    <h4 className="font-extrabold text-emerald-800 text-xs uppercase">
                      Message Dispatched!
                    </h4>
                    <p className="text-[11px] text-slate-600 leading-relaxed max-w-sm mx-auto">
                      Thank you for contacting Edweso Royal Academy. Your
                      general feedback/query message has been successfully
                      logged into our live ledger. A representative will get in
                      touch with you.
                    </p>
                    <button
                  ...
                  <form
                    ...
                    className="space-y-4 text-xs font-semibold"
                  >
                    <h4 className="font-extrabold text-sm text-slate-900 border-b pb-2 mb-2">
                      Write General Feedback Desk
                    </h4>
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 animate-fade-in font-sans">
            ...
            <div className="bg-emerald-800 text-white p-8 sm:p-12 rounded-3xl relative overflow-hidden mb-12 shadow-md">
              ...
              <div className="relative z-10 max-w-2xl space-y-4">
                ...
                <p className="text-xs sm:text-sm text-emerald-100 font-medium leading-relaxed">
                  We believe that education is a sacred partnership between
                  families and the academy. Access handbook policies, syllabus
                  guides, MoMo tutorials, and active terminal resources here.
                </p>
              </div>
            </div>
              ...
              <div className="border-b pb-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <h3 className="font-extrabold text-lg text-slate-900 tracking-tight">
                    Essential Institutional Downloads
                  </h3>
                  <p className="text-xs text-slate-500 font-medium">
                    Verify official regulatory handbooks, fee codes, and GES
                    guidelines.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  .map((doc, idx) => (
                    <div
                      key={idx}
                      className="bg-white border border-slate-200/60 p-5 rounded-2xl flex flex-col justify-between hover:shadow-md transition-all duration-300 hover:border-emerald-500/25 group animate-fade-in"
                    >
                      <div className="space-y-3">
                        ...
                        <div>
                          <h4 className="font-extrabold text-xs text-slate-900 group-hover:text-emerald-800 transition-colors">
                            {doc.title}
                          </h4>
                      ...
                      <div className="border-t border-slate-100 pt-4 mt-4 flex items-center justify-between text-[10px] font-bold text-slate-400">
                        ...
                        <button
                          onClick={() =>
                            alert(
                              `Document "${doc.title}" download triggered. The PDF helper has dispatched the local ledger payload.`,
                            )
                          }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t pt-12">
              <div className="lg:col-span-4 space-y-4">
                ...
                <h3 className="font-extrabold text-lg text-slate-900 tracking-tight">
                  Parent Concern Desk (PTA FAQs)
                </h3>
                <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                  Have urgent questions about academic progress, transportation
                  networks, feeding programs, or computer labs? Read our active
                  regulatory answers.
                </p>
                <div className="bg-slate-100 p-4 rounded-xl border border-slate-200/50 space-y-2">
                  <p className="text-[11px] text-slate-600 leading-relaxed font-bold">
                    Need direct administrative feedback?
                  </p>
                  <button
                    onClick={() => {
              ...
              <div className="lg:col-span-8 space-y-3">
                {[
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-white border border-slate-200/50 rounded-xl overflow-hidden transition-all duration-200"
                    >
                      <button
                        type="button"
                      ...
                      >
                        ...
                        <ChevronDown
                          size={14}
                          className={`text-slate-400 shrink-0 transition-transform duration-300 ${isOpen ? "transform rotate-180 text-emerald-700" : ""}`}
                        />
                      </button>
                      {isOpen && (
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 animate-fade-in font-sans">
            ...
            <div className="bg-slate-900 text-white p-8 sm:p-12 rounded-3xl relative overflow-hidden mb-12 shadow-md border border-slate-800">
              ...
              <div className="relative z-10 max-w-2xl space-y-4">
                ...
                <p className="text-xs sm:text-sm text-slate-300 font-medium leading-relaxed">
                  At Edweso Royal Academy, we employ facilitators of high moral
                  character, academic rigor, and creative pedagogical vision.
                  Discover competitive benefits, professional coaching
                  workshops, and supportive tech facilities.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white border border-slate-200/50 p-5 rounded-2xl space-y-3 shadow-xs"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t pt-12">
              ...
              <div className="lg:col-span-7 space-y-6">
                <div>
                  <h3 className="font-extrabold text-lg text-slate-900 tracking-tight">
                    Active Faculty Vacancies
                  </h3>
                  <p className="text-xs text-slate-500 font-medium">
                    Select a role to populate the digital application dispatch
                    ledger below.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className="bg-white border border-slate-200/50 p-6 rounded-2xl shadow-xs space-y-4 hover:border-emerald-500/30 transition-colors"
                    >
              ...
              <div className="lg:col-span-5 bg-white border border-slate-200/50 rounded-2xl p-6 sm:p-8 self-start space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                    Edweso Royal Academy values dedication, pedagogical
                    innovation, and exceptional moral character. Ready to make a
                    real impact?
                  </p>
                </div>
                <div className="bg-slate-50 border border-slate-200/40 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={14} className="text-emerald-700" />
                    <span className="text-[11px] text-slate-700 font-bold">
                      PTA & GES compliant standards
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={14} className="text-emerald-700" />
                    <span className="text-[11px] text-slate-700 font-bold">
                      Immediate board feedback
                    </span>
                  </div>
                </div>
                <button
      ...
      <div className="mt-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-extrabold text-base tracking-tight text-emerald-800">
                  Edweso Royal Academy
                </span>
              </div>
              <p className="text-xs text-slate-500 leading-relaxed font-semibold">
                Providing holistic, moral-based, and academic excellence in
                Edweso, Ashanti Region, Ghana since 2012. Our mandate is simple:
                Knowledge, Discipline, Excellence.
              </p>
            ...
            <div className="space-y-3">
              <h4 className="font-extrabold text-xs text-slate-900 uppercase tracking-widest">
                Speak To Us
              </h4>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <ChevronRight
                    size={12}
                    className="opacity-0 group-hover:opacity-100 transform translate-x-[-4px] group-hover:translate-x-0 transition-all duration-300"
                  />
                </button>
                <button
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                <button
                  onClick={() => {
                    setActivePage("parent-resources");
                    window.scrollTo({ top: 0, behavior: "smooth" });
                  }}
        ...
        <footer className="bg-slate-900 text-slate-400 py-6 text-center text-[11px] px-4">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <p>
              © 2026 Edweso Royal Academy. All Rights Reserved. Approved by the
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full max-h-[90vh] overflow-y-auto border border-emerald-500/20 text-slate-800 flex flex-col">
            ...
            <div className="bg-slate-950 text-white px-6 py-4 flex items-center justify-between border-b border-slate-800">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-sans font-bold text-xs uppercase tracking-wider text-emerald-400">
            ...
            <div className="bg-emerald-50 px-6 py-3 border-b border-emerald-100/50 flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-medium">
                  Ashanti Region, Ghana • Institutional Registration
                </p>
              </div>
              ...
              {isCareerSubmitted ? (
                <div className="py-6 space-y-4 text-center animate-fade-in">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-semibold max-w-md mx-auto">
                    Your candidate ledger details have been transmitted. Your
                    registration code is{" "}
                    <strong className="font-mono text-emerald-950 font-black">
                      {submittedCareerId}
                    </strong>
                    . The Academic Board and Registrar will inspect your
                    references within 7-10 business days.
                  </p>
                ...
                >
                  <div>
                    ...
                    >
                      <option value="JHS ICT & Computing Specialist">
                        JHS ICT & Computing Specialist
                      </option>
                      <option value="Primary School Class Facilitator (Class 5)">
                        Primary School Class Facilitator (Class 5)
                      </option>
                      <option value="French Language Instructor">
                  ...
                  <div>
                    <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">
                      Prior Pedagogical Experience Summary
                    </label>
                    <textarea
                      rows={4}
                      required
