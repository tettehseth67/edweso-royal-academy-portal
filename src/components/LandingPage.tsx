  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 flex flex-col justify-between">
      ...
      <div className="mt-auto">
        {/* Contact Strip & Multi-Column Footer Navigation */}
        <section id="contact-banner" className="py-16 bg-slate-900 text-slate-300 border-t border-slate-800 font-sans">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            
            {/* Column 1: School Branding & Address */}
            <div className="lg:col-span-2 space-y-4">
              <div className="flex items-center space-x-2">
                <img 
                  src="/assets/images/logo.png" 
                  alt="Edweso Royal Academy Logo" 
                  className="w-14 h-14 rounded-xl object-contain border border-amber-400/20 shadow-md bg-white"
                  referrerPolicy="no-referrer"
                />
                <div>
                  <span className="font-extrabold text-base tracking-tight text-white block leading-tight">Edweso Royal</span>
                  <span className="text-[10px] uppercase font-bold tracking-widest text-amber-500 block leading-none">Academy</span>
                </div>
              </div>
              ...
              <div className="space-y-2 text-xs text-slate-400 font-semibold pt-1">
                ...
                <div className="flex items-center space-x-2.5">
                  <Phone className="text-emerald-500 shrink-0" size={14} />
                  <span>+233 24 412 3456 / +233 20 123 4567</span>
                </div>
                <div className="flex items-center space-x-2.5">
                  <Mail className="text-emerald-500 shrink-0" size={14} />
            ...
            <div className="space-y-3">
              <h4 className="font-extrabold text-xs text-white uppercase tracking-wider border-b border-slate-800 pb-2">Quick Links</h4>
              <div className="flex flex-col space-y-2 text-xs font-semibold text-slate-400">
                <button 
                ...
                <button 
                  onClick={() => { setActivePage('academics'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  Academics
                </button>
            ...
            <div className="space-y-3">
              <h4 className="font-extrabold text-xs text-white uppercase tracking-wider border-b border-slate-800 pb-2">School Info</h4>
              <div className="flex flex-col space-y-2 text-xs font-semibold text-slate-400">
                <button 
                ...
                <button 
                  onClick={() => { setActivePage('mission-vision'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  Mission & Vision
                </button>
                ...
                <button 
                  onClick={() => { setActivePage('policies'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  School Policies
                </button>
            ...
            {/* Column 4: Academics Segment */}
            <div className="space-y-3">
              <h4 className="font-extrabold text-xs text-white uppercase tracking-wider border-b border-slate-800 pb-2">Academics</h4>
              <div className="flex flex-col space-y-2 text-xs font-semibold text-slate-400">
                <button 
                  onClick={() => { setActivePage('academics'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                ...
                <button 
                  onClick={() => { setActivePage('academics'); setAcademicDept('primary'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  Daycare & KG
                </button>
                ...
                <button 
                  onClick={() => { setActivePage('academics'); setAcademicDept('jhs'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  Junior High (JHS)
                </button>
                <button 
                  onClick={() => { setActivePage('academics'); setAcademicDept('shs'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="text-left hover:text-emerald-400 transition-colors cursor-pointer"
                >
                  Senior High (SHS)
                </button>
                <button 
                  onClick={() => { setActivePage('parent-resources'); setSelectedResourceTab('academic'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
            ...
            <div className="space-y-3">
              <h4 className="font-extrabold text-xs text-white uppercase tracking-wider border-b border-slate-800 pb-2">Resources & Media</h4>
              <div className="flex flex-col space-y-2 text-xs font-semibold text-slate-400">
                <button 
                  onClick={() => { setActivePage('fees-plan'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
          ...
          <div className="max-w-7xl mx-auto px-4 mt-12 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-slate-500">
            <div className="flex items-center space-x-4">
              <button 
                onClick={() => { setActivePage('privacy'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                className="hover:text-slate-350 cursor-pointer"
              >
                Privacy Policy
              </button>
              <span>•</span>
            ...
            <div className="flex space-x-3 font-bold text-[10px] text-emerald-500 uppercase tracking-widest font-mono">
              <span>knowledge</span>
              <span>•</span>
        ...
        {/* Footer Bottom */}
        <footer className="bg-slate-950 text-slate-500 py-6 text-center text-[11px] px-4">
