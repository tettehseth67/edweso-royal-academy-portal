                      ...
                      dayLessons.map(les => {
                        ...
                        return (
                          <div 
                            ...
                            className="p-2.5 bg-slate-55/40 hover:bg-emerald-50/50 dark:bg-slate-900/20 dark:hover:bg-slate-900/60 rounded-xl border border-slate-100/80 dark:border-slate-850 text-[11px] text-slate-500 cursor-pointer hover:shadow-xs transition-all hover:-translate-y-0.5"
                          >
                            <p className="font-bold text-slate-800 dark:text-slate-100">{sub ? sub.name : 'Unknown'}</p>
